    ...
    static {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                XLog.printErrStackTrace(TAG, e, "read file error");
            } finally {
                XLangHelper.close(fileInputStream);
            }
        }
        ...
        try {
            ...
            XLog.printErrStackTrace(TAG, e, "read SystemProperties error");
        }
    }
