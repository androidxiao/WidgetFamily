 ...
 */
public class XStateButtonDrawable extends StateListDrawable {
    ...
    public XStateButtonDrawable(View view) {
        mReference = new WeakReference<>(view);
    }


    public void fromAttributeSet(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.XStateButton, defStyleAttr, 0);
        Drawable disabledDa = ta.getDrawable(R.styleable.XStateButton_x_stateDisabled);
        Drawable selectDa = ta.getDrawable(R.styleable.XStateButton_x_stateSelect);
        Drawable enabledDa = ta.getDrawable(R.styleable.XStateButton_x_stateEnabled);
        int pressedDaC = ta.getColor(R.styleable.XStateButton_x_statePressedC, 0);
        int enabledDaC = ta.getColor(R.styleable.XStateButton_x_stateEnabledC, 0);
        int disableDaC = ta.getColor(R.styleable.XStateButton_x_stateDisableC, 0);
        int checkDaC = ta.getColor(R.styleable.XStateButton_x_stateCheckC, 0);
        Drawable pressedDa = ta.getDrawable(R.styleable.XStateButton_x_statePressed);
        Drawable checkDa = ta.getDrawable(R.styleable.XStateButton_x_stateCheck);
        Drawable unCheckDa = ta.getDrawable(R.styleable.XStateButton_x_stateUnCheck);
        int drawableDirection = ta.getInt(R.styleable.XStateButton_x_stateDirection, 1);
