 ...
 * Description:
 */
public class XRelativeLayoutHelper implements XLayout {
    ...
    public XRelativeLayoutHelper(Context context, AttributeSet attrs, int defAttr, View owner) {
        mContext = context;
        ...
        mShadowAlpha = XResHelper.getAttrFloatValue(context, R.attr.x_general_shadow_alpha);
        mBorderRect = new RectF();
        int radius = 0, shadow = 0;
        boolean useThemeGeneralShadowElevation = false;
        if (attrs != null || defAttr != 0) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.XRelativeLayout, defAttr, 0);
            int count = ta.getIndexCount();
            for (int i = 0; i < count; i++) {
                int index = ta.getIndex(i);
                if (index == R.styleable.XRelativeLayout_android_maxWidth) {
                    mWidthLimit = ta.getDimensionPixelSize(index, mWidthLimit);
                } else if (index == R.styleable.XRelativeLayout_android_maxHeight) {
                    mHeightLimit = ta.getDimensionPixelSize(index, mHeightLimit);
                } else if (index == R.styleable.XRelativeLayout_android_minWidth) {
                    mWidthMini = ta.getDimensionPixelSize(index, mWidthMini);
                } else if (index == R.styleable.XRelativeLayout_android_minHeight) {
                    mHeightMini = ta.getDimensionPixelSize(index, mHeightMini);
                } else if (index == R.styleable.XRelativeLayout_x_topDividerColor) {
                    mTopDividerColor = ta.getColor(index, mTopDividerColor);
                } else if (index == R.styleable.XRelativeLayout_x_topDividerHeight) {
                    mTopDividerHeight = ta.getDimensionPixelSize(index, mTopDividerHeight);
                } else if (index == R.styleable.XRelativeLayout_x_topDividerInsetLeft) {
                    mTopDividerInsetLeft = ta.getDimensionPixelSize(index, mTopDividerInsetLeft);
                } else if (index == R.styleable.XRelativeLayout_x_topDividerInsetRight) {
                    mTopDividerInsetRight = ta.getDimensionPixelSize(index, mTopDividerInsetRight);
                } else if (index == R.styleable.XRelativeLayout_x_bottomDividerColor) {
                    mBottomDividerColor = ta.getColor(index, mBottomDividerColor);
                } else if (index == R.styleable.XRelativeLayout_x_bottomDividerHeight) {
                    mBottomDividerHeight = ta.getDimensionPixelSize(index, mBottomDividerHeight);
                } else if (index == R.styleable.XRelativeLayout_x_bottomDividerInsetLeft) {
                    mBottomDividerInsetLeft = ta.getDimensionPixelSize(index, mBottomDividerInsetLeft);
                } else if (index == R.styleable.XRelativeLayout_x_bottomDividerInsetRight) {
                    mBottomDividerInsetRight = ta.getDimensionPixelSize(index, mBottomDividerInsetRight);
                } else if (index == R.styleable.XRelativeLayout_x_leftDividerColor) {
                    mLeftDividerColor = ta.getColor(index, mLeftDividerColor);
                } else if (index == R.styleable.XRelativeLayout_x_leftDividerWidth) {
                    mLeftDividerWidth = ta.getDimensionPixelSize(index, mLeftDividerWidth);
                } else if (index == R.styleable.XRelativeLayout_x_leftDividerInsetTop) {
                    mLeftDividerInsetTop = ta.getDimensionPixelSize(index, mLeftDividerInsetTop);
                } else if (index == R.styleable.XRelativeLayout_x_leftDividerInsetBottom) {
                    mLeftDividerInsetBottom = ta.getDimensionPixelSize(index, mLeftDividerInsetBottom);
                } else if (index == R.styleable.XRelativeLayout_x_rightDividerColor) {
                    mRightDividerColor = ta.getColor(index, mRightDividerColor);
                } else if (index == R.styleable.XRelativeLayout_x_rightDividerWidth) {
                    mRightDividerWidth = ta.getDimensionPixelSize(index, mRightDividerWidth);
                } else if (index == R.styleable.XRelativeLayout_x_rightDividerInsetTop) {
                    mRightDividerInsetTop = ta.getDimensionPixelSize(index, mRightDividerInsetTop);
                } else if (index == R.styleable.XRelativeLayout_x_rightDividerInsetBottom) {
                    mRightDividerInsetBottom = ta.getDimensionPixelSize(index, mRightDividerInsetBottom);
                } else if (index == R.styleable.XRelativeLayout_x_borderColorViewGroup) {
                    mBorderColor = ta.getColor(index, mBorderColor);
                } else if (index == R.styleable.XRelativeLayout_x_borderWidthViewGroup) {
                    mBorderWidth = ta.getDimensionPixelSize(index, mBorderWidth);
                } else if (index == R.styleable.XRelativeLayout_x_radiusViewGroup) {
                    radius = ta.getDimensionPixelSize(index, 0);
                } else if (index == R.styleable.XRelativeLayout_x_outerNormalColor) {
                    mOuterNormalColor = ta.getColor(index, mOuterNormalColor);
                } else if (index == R.styleable.XRelativeLayout_x_hideRadiusSide) {
                    mHideRadiusSide = ta.getInt(index, mHideRadiusSide);
                } else if (index == R.styleable.XRelativeLayout_x_showBorderOnlyBeforeL) {
                    mIsShowBorderOnlyBeforeL = ta.getBoolean(index, mIsShowBorderOnlyBeforeL);
                } else if (index == R.styleable.XRelativeLayout_x_shadowElevation) {
                    shadow = ta.getDimensionPixelSize(index, shadow);
                } else if (index == R.styleable.XRelativeLayout_x_shadowAlpha) {
                    mShadowAlpha = ta.getFloat(index, mShadowAlpha);
                } else if (index == R.styleable.XRelativeLayout_x_useThemeGeneralShadowElevation) {
                    useThemeGeneralShadowElevation = ta.getBoolean(index, false);
                } else if (index == R.styleable.XRelativeLayout_x_outlineInsetLeft) {
                    mOutlineInsetLeft = ta.getDimensionPixelSize(index, 0);
                } else if (index == R.styleable.XRelativeLayout_x_outlineInsetRight) {
                    mOutlineInsetRight = ta.getDimensionPixelSize(index, mOutlineInsetRight);
                } else if (index == R.styleable.XRelativeLayout_x_outlineInsetTop) {
                    mOutlineInsetTop = ta.getDimensionPixelSize(index, 0);
                } else if (index == R.styleable.XRelativeLayout_x_outlineInsetBottom) {
                    mOutlineInsetBottom = ta.getDimensionPixelSize(index, mOutlineInsetBottom);
                } else if (index == R.styleable.XRelativeLayout_x_outlineExcludePadding) {
                    mIsOutlineExcludePadding = ta.getBoolean(index, false);
                }
            }
            ta.recycle();
            if (shadow == 0 && useThemeGeneralShadowElevation) {
                shadow = XResHelper.getAttrDimen(context, R.attr.x_general_shadow_elevation);
            }
    ...
    public void setUseThemeGeneralShadowElevation() {
        mShadowElevation = XResHelper.getAttrDimen(mContext, R.attr.x_general_shadow_elevation);
    ...
    @Override
    public void onlyShowTopDivider(int topInsetLeft, int topInsetRight, int topDiverHeight, int topDividerColor) {
        updateTopDivider(topInsetLeft, topInsetRight, topDiverHeight, topDividerColor);
        mLeftDividerWidth = 0;
    ...
    private void drawRoundRect(Canvas canvas, RectF rectF, float[] radiusArray, Paint paint) {
        mPath.reset();
        mPath.addRoundRect(rectF, radiusArray, Path.Direction.CW);
