...
public class XRoundConstraintLayoutState {
    ...
    public void fromAttributeSet(Context context , AttributeSet set, int defStyleAttr) {
        ...
        ColorStateList colorBg = ta.getColorStateList(R.styleable.XRoundConstraintLayout_x_backgroundColor);
        ColorStateList colorBorder = ta.getColorStateList(R.styleable.XRoundConstraintLayout_x_borderColor);
        int borderWidth = ta.getDimensionPixelSize(R.styleable.XRoundConstraintLayout_x_borderWidth, 0);
        boolean isRadiusAdjustBounds = ta.getBoolean(R.styleable.XRoundConstraintLayout_x_isRadiusAdjustBounds, false);
        int mRadius = ta.getDimensionPixelSize(R.styleable.XRoundConstraintLayout_x_radius, 0);
        int mRadiusTopLeft = ta.getDimensionPixelSize(R.styleable.XRoundConstraintLayout_x_radiusTopLeft, 0);
        int mRadiusTopRight = ta.getDimensionPixelSize(R.styleable.XRoundConstraintLayout_x_radiusTopRight, 0);
        int mRadiusBottomLeft = ta.getDimensionPixelSize(R.styleable.XRoundConstraintLayout_x_radiusBottomLeft, 0);
        int mRadiusBottomRight = ta.getDimensionPixelSize(R.styleable.XRoundConstraintLayout_x_radiusBottomRight, 0);
        ColorStateList disableColor = ta.getColorStateList(R.styleable.XRoundConstraintLayout_x_disableColor);
        ColorStateList pressColor = ta.getColorStateList(R.styleable.XRoundConstraintLayout_x_pressColor);
        int startColor = ta.getColor(R.styleable.XRoundConstraintLayout_x_startColor, 0);
        int middleColor = ta.getColor(R.styleable.XRoundConstraintLayout_x_middleColor, 0);
        int endColor = ta.getColor(R.styleable.XRoundConstraintLayout_x_endColor, 0);
        int gradientOrientation = ta.getInt(R.styleable.XRoundLinearLayout_x_gradientOrientation, -1);
