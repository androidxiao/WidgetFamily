...
public class XRoundLinearLayoutState {
    ...
    public void fromAttributeSet(Context context , AttributeSet set, int defStyleAttr) {
        ...
        ColorStateList colorBg = ta.getColorStateList(R.styleable.XRoundLinearLayout_x_backgroundColor);
        ColorStateList colorBorder = ta.getColorStateList(R.styleable.XRoundLinearLayout_x_borderColor);
        int borderWidth = ta.getDimensionPixelSize(R.styleable.XRoundLinearLayout_x_borderWidth, 0);
        boolean isRadiusAdjustBounds = ta.getBoolean(R.styleable.XRoundLinearLayout_x_isRadiusAdjustBounds, false);
        int mRadius = ta.getDimensionPixelSize(R.styleable.XRoundLinearLayout_x_radius, 0);
        int mRadiusTopLeft = ta.getDimensionPixelSize(R.styleable.XRoundLinearLayout_x_radiusTopLeft, 0);
        int mRadiusTopRight = ta.getDimensionPixelSize(R.styleable.XRoundLinearLayout_x_radiusTopRight, 0);
        int mRadiusBottomLeft = ta.getDimensionPixelSize(R.styleable.XRoundLinearLayout_x_radiusBottomLeft, 0);
        int mRadiusBottomRight = ta.getDimensionPixelSize(R.styleable.XRoundLinearLayout_x_radiusBottomRight, 0);
        ColorStateList disableColor = ta.getColorStateList(R.styleable.XRoundLinearLayout_x_disableColor);
        ColorStateList pressColor = ta.getColorStateList(R.styleable.XRoundLinearLayout_x_pressColor);
        int startColor = ta.getColor(R.styleable.XRoundLinearLayout_x_startColor, 0);
        int middleColor = ta.getColor(R.styleable.XRoundLinearLayout_x_middleColor, 0);
        int endColor = ta.getColor(R.styleable.XRoundLinearLayout_x_endColor, 0);
